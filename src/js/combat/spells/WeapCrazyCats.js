...
/**
 * @typedef {import("../weapons/WeapSummon").default} summonerWeapon
 */

export default class WeapCrazyCats extends Weapon {

    constructor(owner, summonerWeap) {
        ...
        /** @type {summonerWeapon} */
        this._summonerWeap = summonerWeap;
